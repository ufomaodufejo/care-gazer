    ...
    <DefaultLayout>
      <div className="relative">
          ...
          <div className="flex flex-col gap-[16px] mt-[176px] ml-[200px] ">
            ...
            <div className="flex gap-6">
              <h1 className="text-[32px] text-[#000000]">
                Experiencing frequent Nausea and Vomiting?
              </h1>
        ...
        <div className="absolute top-[250px] left-[1300px]">
          <div className="w-[280px] h-[280px] bg-[#023089] relative rounded-full">
            <div className="bg-[#AD009C] absolute w-[330px] h-[330px] rounded-full flex items-center justify-center overflow-hidden mt-10 mr-10 border-[3px] border-[#FFFFFF]">
