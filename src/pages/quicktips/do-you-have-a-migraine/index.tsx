    ...
    <DefaultLayout>
      <div className="relative">
        ...
        <div className="absolute top-[250px] left-[1300px]">
          <div className="w-[280px] h-[280px] bg-[#0300A0] relative rounded-full">
            <div className="bg-[#FF4747] absolute w-[330px] h-[330px] rounded-full flex items-center justify-center overflow-hidden mt-10 mr-10 border-[3px] border-[#FFFFFF]">
