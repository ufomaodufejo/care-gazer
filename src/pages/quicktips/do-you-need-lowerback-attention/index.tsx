    ...
    <DefaultLayout>
      <div className="relative">
          ...
          <div className="flex flex-col gap-[16px] mt-[176px] ml-[200px] ">
            ...
            <div className="flex gap-6">
              <h1 className="text-[32px] text-[#000000]">
                Do you need lowerback attention?
              </h1>
        ...
        <div className="absolute top-[250px] left-[1300px]">
          <div className="w-[280px] h-[280px] bg-[#10312B] relative rounded-full">
            <div className="bg-[#9747FF] absolute w-[330px] h-[330px] rounded-full flex items-center justify-center overflow-hidden mt-10 mr-10 border-[3px] border-[#FFFFFF]">
