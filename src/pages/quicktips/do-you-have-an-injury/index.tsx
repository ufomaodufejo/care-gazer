    ...
    <DefaultLayout>
      <div className="relative">
        ...
        <div className="absolute top-[250px] left-[1300px]">
          <div className="w-[280px] h-[280px] bg-[#AD009C] relative rounded-full">
            <div className="bg-[#023089] absolute w-[330px] h-[330px] rounded-full flex items-center justify-center overflow-hidden mt-10 mr-10 border-[3px] border-[#FFFFFF]">
